...
V0     =       138       # true airspeed in the stationary flight condition [m/sec]
alpha0 =      np.deg2rad(1.7)        # angle of attack in the stationary flight condition [rad]
th0    =      np.deg2rad(1.7)     # pitch angle in the stationary flight condition [rad]
